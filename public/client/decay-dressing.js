...
const DECAY_GEOMETRY = Object.freeze({
  ...
  support: sharedGeometry(new THREE.BoxGeometry(0.075, 0.82, 0.075).translate(0, 0.41, 0)),
  fence: sharedGeometry(new THREE.BoxGeometry(0.92, 0.42, 0.06).translate(0, 0.21, 0)),
